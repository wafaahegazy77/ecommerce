                        ...
                        >
                            <SwiperSlide>
                                <div className="item">
                                    ...
                                    <img src="./src/img/banner_Hero1.jpg" className='bg' alt="Hero Banner" />
                                </div>
                            ...
                            <SwiperSlide>
                                <div className="item">
                                    ...
                                    <img src="./src/img/banner_Hero2.jpg" className='bg' alt="Hero Banner" />
                                </div>
                            ...
                            <SwiperSlide>
                                <div className="item">
                                    ...
                                    <img src="./src/img/banner_Hero3.jpg" className='bg' alt="Hero Banner" />
                                </div>
